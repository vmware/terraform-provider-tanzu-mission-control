...
var labelSelectorSchema = &schema.Schema{
	Type:        schema.TypeList,
	Description: "The label selector to selectively adding individual objects.\nIf not specified, all objects are included.",
	MaxItems:    1,
	Optional:    true,
	Elem: &schema.Resource{
		Schema: labelSelectorResource,
