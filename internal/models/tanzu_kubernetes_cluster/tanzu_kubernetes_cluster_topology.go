...
type VmwareTanzuManageV1alpha1ManagementclusterProvisionerTanzukubernetesclusterTopology struct {
	...
	NodePools []*VmwareTanzuManageV1alpha1ManagementclusterProvisionerTanzukubernetesclusterNodepoolDefinition `json:"nodePools"`

	// Variables configuration for the cluster.
	Variables []*VmwareTanzuManageV1alpha1ManagementclusterProvisionerTanzukubernetesclusterCommonClusterClusterVariable `json:"variables"`
