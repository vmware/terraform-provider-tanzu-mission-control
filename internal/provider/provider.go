...
import (
	...
	tanzukubernetescluster "github.com/vmware/terraform-provider-tanzu-mission-control/internal/resources/tanzukubernetescluster"
...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			tanzukubernetescluster.ResourceName: tanzukubernetescluster.ResourceTMCTKCCluster(),
		},
		DataSourcesMap: map[string]*schema.Resource{
			...
			tanzukubernetescluster.ResourceName: tanzukubernetescluster.DataSourceTMCTKCCluster(),
		},
