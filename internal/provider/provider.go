...
import (
	...
	"github.com/vmware/terraform-provider-tanzu-mission-control/internal/resources/managementclusterregistration"
...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			managementclusterregistration.ResourceName: managementclusterregistration.ResourceManagementClusterRegistration(),
		},
		DataSourcesMap: map[string]*schema.Resource{
			...
			managementclusterregistration.ResourceName: managementclusterregistration.DataSourceManagementClusterRegistration(),
		},
