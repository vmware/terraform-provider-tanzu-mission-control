/*
Cluster group scoped Tanzu Mission Control security policy with custom input recipe.
This policy is applied on a cluster group with the custom configuration option and is inherited by the clusters.
