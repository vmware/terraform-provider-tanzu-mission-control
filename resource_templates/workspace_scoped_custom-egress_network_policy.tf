// Create/ Delete/ Update Tanzu Mission Control workspace scoped custom-egress network policy entry
resource "tanzu-mission-control_network_policy" "workspace_scoped_custom-egress_destination-ip_network_policy" {
