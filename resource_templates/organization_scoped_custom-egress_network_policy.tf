// Create/ Delete/ Update Tanzu Mission Control organization scoped custom-egress network policy entry
resource "tanzu-mission-control_network_policy" "organization_scoped_custom-egress_destination-ip_network_policy" {
