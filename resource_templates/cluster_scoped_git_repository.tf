...
# Read Tanzu Mission Control cluster scoped gitrepository : fetch cluster scoped gitrepository details
...
# Create Tanzu Mission Control cluster scoped gitrepository entry
