// Create/ Delete/ Update Tanzu Mission Control organization scoped custom-ingress network policy entry
resource "tanzu-mission-control_network_policy" "organization_scoped_custom-ingress_source-ip_network_policy" {
