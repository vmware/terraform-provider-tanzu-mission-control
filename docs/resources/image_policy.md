...
- `imagename` (String) Allowed image names, wildcards are supported(for example: fooservice/_). Empty field is equivalent to _.
...
- `hostname` (String) Allowed image hostnames, wildcards are supported(for example: _.mycompany.com). Empty field is equivalent to _.
- `imagename` (String) Allowed image names, wildcards are supported(for example: fooservice/_). Empty field is equivalent to _.
